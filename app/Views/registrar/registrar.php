                            ...
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="txtFecha" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="txtFechaResolucion">
                                    </div>
                                </div>
                            </form>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card shadow mb-3">
                                    <div class="card-body text-center">
                                        <table class="table table-hover text-center" id="tbFamiliares">
                            ...
                            <form>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <button type="button" class="btn btn-primary float-right" id="btnAgregar" onclick="reg.insertarBeneficios();">Agregar</button>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <table class="table table-hover text-center" id="tbBeneficios">   
                                            <thead class="thead-dark">
                                                <tr>
                                                    <th>PARENTESCO</th>
                                                    <th>PENSIÓN</th>
                        ...
                        <div class="tab-pane fade" id="pills-necesidades" role="tabpanel" aria-labelledby="pills-necesidades-tab">
                            <form>
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="cmbVivienda">
                                            ...
                                            <option>ADQUISICIÓN DE VIVIENDA</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="cmbVehiculo">
                                            <option>SELECCIONE</option>
                                            <option>REPARACIÓN DE VEHÍCULO</option>
                                            <option>ADQUISICIÓN DE VEHÍCULO</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" id="cmbBienestar">
                                            ...
                                            <option>TRATAMIENTO PROLONGADO</option>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Ente</label>
                                        <input type="text" class="form-control" id="txtEnte" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Otros</label>
                                        <input type="text" class="form-control" id="txtOtros" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div>
                                </div>
                            </form>
                        </div>
                        <button type="button" class="btn btn-primary" id="btnGuardar" onclick="reg.insertar();">Guardar</button>
                        <button type="button" class="btn btn-primary float-right" id="btnCancelar">Cancelar</button>
                    </div>
                </div>   
            </div> 
        </div> 
...
<script src="<?php echo base_url()?>/public/js/registrar.js"></script>
<script>
